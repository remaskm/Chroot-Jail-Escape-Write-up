...
### ** Live Demo – Build Your Own Vulnerable Chroot Jail **
...
### **2. Bootstrap a minimal Kali system into the jail**
...
### **3. Bind-mount required kernel and device interfaces**
...
### **4. Enter the jail and create the low-privilege user**
...
# **5. Planting SUID Vulnerabilities**
...
### **6. Create the flags as proof of privilege escalation**
...
# **1. Enumeration – Finding the Vulnerabilities**
...
# **2. Level 1 – Exploiting SUID /bin/bash**
...
# **3. Level 2 – Exploiting SUID /bin/dash**
...
# **4. Level 3 – Exploiting SUID /usr/bin/find**
...
# ** Fully Escaping the Chroot Jail into the Real Host**
