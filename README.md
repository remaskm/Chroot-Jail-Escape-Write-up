...
### **1.1 Create the chroot directory**
...
### **1.2 Bootstrap a minimal Kali system into the jail**
...
### **1.3 Bind-mount required kernel and device interfaces**
...
### **1.4 Enter the jail and create the low-privilege user**
...
### **1.5 Planting SUID Vulnerabilities**
...
### **1.6 Create the flags as proof of privilege escalation**
...
## **2. Challenge – Capture All 3 Flags**
...
### **2.1 Enumeration – Finding the Vulnerabilities**
...
### **2.2 Level 1 – Exploiting SUID /bin/bash**
...
### **2.3 Level 2 – Exploiting SUID /bin/dash**
...
### **2.4 Level 3 – Exploiting SUID /usr/bin/find**
...
## **3. Fully Escaping the Chroot Jail into the Real Host**
...
### **3.1 Permission Misconfiguration**
...
```bash
whoami    # should show actual host, not chroot environment
...
Cleanup should be done to return the system to its initial state, which involves unmounting the bind-mounted filesystems and removing the chroot directory.
...
## **1. Chroot is NOT a security boundary**
...
## **2. SUID binaries inside a jail = instant compromise**
...
## **3. These vulnerabilities still exist in real systems**
